...
# Sample function to calculate utility based on service level, expected return, and variance
def calculate_utility(expected_return, variance, service_level_achievement, lambda_1, lambda_2, lambda_3, holding_cost, stockout_cost, ordering_cost):
